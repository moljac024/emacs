...
;; last update: Sat Apr 28 11:40:51 CEST 2012 by moljac024
...
(defun Lorem-ipsum-insert-paragraphs (&optional num)
  ...
  (if (> num 0)
      (progn
        (insert (concat
                 (mapconcat 'identity
                            (nth (if (called-interactively-p 'any) 0 (random (length Lorem-ipsum-text)))
                                 Lorem-ipsum-text) " ")
...
(defun Lorem-ipsum-insert-sentences (&optional num)
  ...
  (if (> num 0)
      (progn
        (let ((para
               (nth (if (called-interactively-p 'any) 0 (random (length Lorem-ipsum-text))) Lorem-ipsum-text)))
          (insert (concat (nth (if (called-interactively-p 'any) 0 (random (length para))) para) Lorem-ipsum-sentence-separator)))
...
(defun Lorem-ipsum-insert-list (&optional num)
  ...
  (if (> num 0)
      (progn
        (if (called-interactively-p 'any) (insert Lorem-ipsum-list-beginning))
        (let ((para (nth (if (called-interactively-p 'any) 0 (random (length Lorem-ipsum-text))) Lorem-ipsum-text)))
          (insert (concat Lorem-ipsum-list-bullet
                          (nth (if (called-interactively-p 'any) 0 (random (length para))) para)
